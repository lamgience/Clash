function main(config) {
  config["proxy-groups"] = [
    ...
    },
    {
      ...
      name: "机场专线",
      type: "select",
      proxies: ["DIRECT","自动选择","节点选择","手动切换","香港节点","台湾节点","美国节点","日本节点","狮城节点","英国节点","韩国节点","俄罗斯节点"],
    },
    {
      icon: "https://img.icons8.com/?size=100&id=mSC3ebe4W6w6&format=png&color=000000",
      name: "AIGC",
      type: "select",
      proxies: ["自动选择","节点选择","手动切换","美国节点","香港节点","台湾节点","日本节点","狮城节点","英国节点","韩国节点","俄罗斯节点","DIRECT"],
    },
    {
    ...
    },
    {
      ...
      name: "Netflix",
      type: "select",
      proxies: ["奈飞节点","节点选择","自动选择","手动切换","香港节点","台湾节点","美国节点","日本节点","狮城节点","英国节点","韩国节点","俄罗斯节点","DIRECT"],
    },
    {
    ...
    },
    {
      ...
      name: "苹果服务",
      type: "select",
      proxies: ["DIRECT","自动选择","手动切换","节点选择","香港节点","台湾节点","美国节点","日本节点","狮城节点","英国节点","韩国节点","俄罗斯节点"],
    }, 
    {
    ...
    },
    {
      ...
      "include-all": true,
      "exclude-filter": "(?i)GB|Traffic|Expire|Premium|频道|订阅|ISP|流量|到期|重置|请勿|剩余流量|距离下次重置剩余|套餐到期|跳转域名|请勿连接",
      filter: "(?i)FR|法国|MY|马来西亚|BR|巴西|CA|加拿大|ES|西班牙|IN|印度|MX|墨西哥|LU|卢森堡|TR|土耳其|IL|以色列|IT|意大利|NL|荷兰|DE|德国|AU|澳大利亚|TH|泰国|KZ|哈萨克斯坦",
      name: "其他节点",
      type: "url-test",
      interval: 300,
    },
